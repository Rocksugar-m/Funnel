...
def load_model_and_tokenizer(args):
    is_sparse_model = args.is_sparse
...
def main():
    ...
    if args.is_sparse :
        assert not args.do_train, "args.is_sparse requires args.do_train=False"
        assert args.do_eval, "args.is_sparse requires args.do_eval=True"
